...
const Dashboard = () => {
  return (
    ...
    <div className='relative flex flex-col md:flex-row h-screen '>
        ...
        <nav
      class="bg-[#85a4c0] shadow-lg h-screen fixed top-0 left-0 min-w-[260px] py-6 px-6 font-[sans-serif] flex flex-col overflow-auto">

      <div class="flex flex-wrap items-center cursor-pointer my-20">
        <div class="relative">
        ...
        <div class="ml-4 my-4">
          <p class="text-sm text-gray-200">John Doe</p>
          <p class="text-xs text-gray-200 mt-0.5">D.IN Medicine</p>
        </div>
      </div>

      <div class="relative bg-[#f7fafc] px-4 py-3 rounded-md my-">
      ...
      <ul class="space-y-10 flex-1 mt-4 mb-10">
        <li>
          <Link to="/Dashboard" class="text-gray-300 hover:text-white text-sm flex items-center rounded-md">
        ...
        <li>
          <Link to="/AllHostels" class="text-gray-300 hover:text-white text-sm flex items-center rounded-md">
