...
const About=()=>{
    return(
        <>
  <div className="relative flex flex-col md:flex-row h-screen items-center justify-center border-t-8  bg-[#f7fafc]">
    {/* Text Section */}
    <div className="w-full md:w-1/2 p-10 md:p-20">
      <h1 className="text-blue-500 text-4xl font-bold  text-center mb-10">ABOUT US</h1>
      <p className="text-blue-500 text-center leading-relaxed md:text-left md:p-0">
    ...
    {/* Image Section */}
    <div className="w-full md:w-2/2   p-5 md:p-20">
      <img className="rounded-lg shadow-lg object-cover  w-full h-full" src="./about.jpg" alt="HostelEase" />
    </div>
  </div>
</>
