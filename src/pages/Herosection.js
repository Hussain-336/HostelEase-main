...
const Herosection=()=>{
    return(
    <>
    <div className=" bg-[#b9d2dd] text-blue-500 min-h-screen max-h-full py-56 font-bold  ">
        ...
        <button type='button' class="flex items-center justify-center bg-[#5596db] hover:bg-transparent px-5">
